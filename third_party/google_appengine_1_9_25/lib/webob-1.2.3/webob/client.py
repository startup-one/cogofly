...
class SendRequest:
    ...
    def __init__(self, HTTPConnection=six.moves.http_client.HTTPConnection,
    ...
    def _timeout_supported(self, ConnClass):
        if sys.version_info < (2, 7) and ConnClass in (
            six.moves.http_client.HTTPConnection, six.moves.http_client.HTTPSConnection): # pragma: no cover
            return False
        return True
