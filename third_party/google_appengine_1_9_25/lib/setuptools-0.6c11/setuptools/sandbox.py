...
import os, sys, six.moves.builtins, tempfile, operator, pkg_resources
...
class AbstractSandbox:
    ...
    def run(self, func):
        ...
        try:
            self._copy(self)
            six.moves.builtins.file = self._file
            six.moves.builtins.open = self._open
            self._active = True
            return func()
        finally:
            self._active = False
            six.moves.builtins.open = _file
            six.moves.builtins.file = _open
            self._copy(_os)
