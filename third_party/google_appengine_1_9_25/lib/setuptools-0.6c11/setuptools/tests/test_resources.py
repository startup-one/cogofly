...
class RequirementsTests(TestCase):
    ...
    def testVersionEquality(self):
        ...
        self.assertFalse(d("setuptools-0.3a4.egg") in r1)
        self.assertFalse(d("setuptools-0.3a1.egg") in r1)
        self.assertFalse(d("setuptools-0.3a4.egg") in r2)

        self.assertTrue(d("setuptools-0.3a2.egg") in r1)
        self.assertTrue(d("setuptools-0.3a2.egg") in r2)
        self.assertTrue(d("setuptools-0.3a3.egg") in r2)
        self.assertTrue(d("setuptools-0.3a5.egg") in r2)
