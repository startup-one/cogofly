...
project = 'argparse'
copyright = '2011, Steven J. Bethard'
...
latex_documents = [
  ('index', 'argparse.tex', 'argparse Documentation',
   'Steven J. Bethard', 'manual'),
]
...
man_pages = [
    ('index', 'argparse', 'argparse Documentation',
     ['Steven J. Bethard'], 1)
]
...
texinfo_documents = [
  ('index', 'argparse', 'argparse Documentation', 'Steven J. Bethard',
