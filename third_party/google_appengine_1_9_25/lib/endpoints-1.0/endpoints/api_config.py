...
class _ApiInfo(object):
  ...
  def __init__(self, common_info, resource_name=None, path=None, audiences=None,
    ...
    _CheckListType(audiences, six.string_types, 'audiences')
    _CheckListType(scopes, six.string_types, 'scopes')
    _CheckListType(allowed_client_ids, six.string_types, 'allowed_client_ids')
...
class ApiAuth(object):
  ...
  def __init__(self, allow_cookie_auth=None, blocked_regions=None):
    ...
    _CheckListType(blocked_regions, six.string_types, 'blocked_regions')
...
class ApiConfigGenerator(object):
  ...
  def __params_descriptor(self, message_type, request_kind, path, method_id):
    ...
    for field_name, matched_path_parameters in six.iteritems(path_parameter_dict):
  ...
  def __schema_descriptor(self, services):
    ...
    for service in services:
      ...
      for protorpc_method_name in six.iterkeys(protorpc_methods):
  ...
  def __api_descriptor(self, services, hostname=None):
    ...
    for service in services:
      ...
      for protorpc_meth_name, protorpc_meth_info in six.iteritems(remote_methods):
