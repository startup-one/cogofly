...
class EncoderTestCase(ClassCacheClearingTestCase, EncoderMixIn):
    ...
    def test_string(self):
        ...
        self.assertEncoded(
            'ᚠᛇᚻ', '\x02\x00\t\xe1\x9a\xa0\xe1\x9b\x87\xe1\x9a\xbb'
        )
...
class DecoderTestCase(ClassCacheClearingTestCase, DecoderMixIn):
    ...
    def test_post_process(self):
        ...
        # setup complete
        bytes = pyamf.encode('foo', encoding=pyamf.AMF0).getvalue()
