...
class Markup(six.text_type):
    ...
    def join(self, seq):
        return self.__class__(six.text_type.join(self, list(map(escape, seq))))
    join.__doc__ = six.text_type.join.__doc__

    def split(self, *args, **kwargs):
        return list(map(self.__class__, six.text_type.split(self, *args, **kwargs)))
    split.__doc__ = six.text_type.split.__doc__

    def rsplit(self, *args, **kwargs):
        return list(map(self.__class__, six.text_type.rsplit(self, *args, **kwargs)))
    rsplit.__doc__ = six.text_type.rsplit.__doc__

    def splitlines(self, *args, **kwargs):
        return list(map(self.__class__, six.text_type.splitlines(self, *args, **kwargs)))
    ...
    if hasattr(six.text_type, 'partition'):
        def partition(self, sep):
            return tuple(map(self.__class__,
                             six.text_type.partition(self, escape(sep))))
