...
try:
    dict.iterkeys
    # Python 2
    iterkeys = lambda d: six.iterkeys(d)
...
try:
    ...
    from six.moves.http_client import BadStatusLine, HTTPConnection, HTTPSConnection, IncompleteRead, NotConnected
...
try:
    ...
    # Python 2
    from six.moves.urllib.parse import unquote as parse_unquote
    def unquote_qs(atom, encoding, errors='strict'):
