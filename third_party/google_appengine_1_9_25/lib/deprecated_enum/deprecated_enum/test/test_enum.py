...
def setup_enum_value_fixtures(testcase):
    ...
    for enumtype, params in list(testcase.valid_values.items()):
...
class Test_Module(unittest.TestCase):
    ...
    def test_author_name_is_string(self):
        ...
        self.assertTrue(isinstance(mod_author_name, six.string_types))
    ...
    def test_author_email_is_string(self):
        ...
        self.assertTrue(isinstance(mod_author_email, six.string_types))

    def test_author_is_string(self):
        """ Module should have __author__ string. """
        mod_author = self.module.__author__
        self.assertTrue(isinstance(mod_author, six.string_types))
...
class Test_EnumValue(unittest.TestCase):
    ...
    def test_instantiate(self):
        ...
        for enumtype, params in list(self.valid_values.items()):
            for key, instance in list(params['values'].items()):
                self.assertTrue(instance)
    ...
    def test_comparison_method_has_docstring(self):
        ...
        for compare_func in compare_functions:
            ...
            compare_method = getattr(enum.EnumValue, func_name)
            self.assertTrue(
                isinstance(compare_method.__doc__, six.string_types))
