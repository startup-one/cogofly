...
class DataStoreClassAlias(pyamf.ClassAlias):
    ...
    def getCustomProperties(self):
        ...
        for name, prop in six.iteritems(self.klass.properties()):
    ...
    def getEncodableAttributes(self, obj, codec=None):
        ...
        if self.reference_properties and gae_objects:
            for name, prop in six.iteritems(self.reference_properties):
    ...
    def getDecodableAttributes(self, obj, attrs, codec=None):
        ...
        if self.properties:
            for k in [k for k in list(attrs.keys()) if k in list(self.properties.keys())]:
                ...
                if isinstance(prop, db.FloatProperty) and isinstance(v, six.integer_types):
                    attrs[k] = float(v)
