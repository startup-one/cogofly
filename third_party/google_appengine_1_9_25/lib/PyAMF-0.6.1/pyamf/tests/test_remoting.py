...
class DecoderTestCase(unittest.TestCase):
    ...
    def test_invalid_header_data_length(self):
        ...
        self.assertRaises(pyamf.DecodeError, remoting.decode,
    ...
    def test_simple_body(self):
        self.assertRaises(IOError, remoting.decode,
...
class ReprTestCase(unittest.TestCase):
    ...
    def test_base_fault(self):
        r = remoting.BaseFault(code='å', type='å', description='å', details='å')
