...
class DecoderTestCase(unittest.TestCase):
    ...
    def test_amf3(self):
        ...
        self.assertEqual(sol.decode(bytes), ('EchoTest',
            {'httpUri': 'http://localhost:8000/gateway/', 'rtmpUri': 'rtmp://localhost/echo'}))
...
class EncoderTestCase(unittest.TestCase):
    ...
    def test_amf3(self):
        ...
        stream = sol.encode('EchoTest',
            {'httpUri': 'http://localhost:8000/gateway/', 'rtmpUri': 'rtmp://localhost/echo'}, encoding=pyamf.AMF3)
