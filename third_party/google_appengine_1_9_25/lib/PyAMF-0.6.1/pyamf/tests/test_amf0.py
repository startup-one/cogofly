...
class EncoderTestCase(ClassCacheClearingTestCase, EncoderMixIn):
    ...
    def test_string(self):
        ...
        self.assertEncoded('ᚠᛇᚻ', '\x02\x00\t\xe1\x9a\xa0\xe1\x9b\x87\xe1\x9a\xbb')
    ...
    def test_iterate(self):
        ...
        self.assertEqual(next(self.encoder), '\x02\x00\x06\xc6\x92\xc3\xb8\xc3\xb8')
...
class DecoderTestCase(ClassCacheClearingTestCase, DecoderMixIn):
    ...
    def test_iterate(self):
        ...
        self.assertEqual(next(self.decoder), '\u16a0\u16c7\u16bb')
...
class AMF0ContextTestCase(unittest.TestCase):
    ...
    def test_decode(self):
        ...
        self.assertEqual(a, {'value': 'tester@trial.com',
            'format': 'urn:TribalDDB:identity:email'})
        self.assertEqual(b, {'type': 'urn:TribalDDB:authentication:password',
            'value': 'passwrd'})
        self.assertEqual(c, {'PostalCode': '12345',
            'DateOfBirth': {'month': 4, 'day': 15, 'year': 1990},
            'EmailAddress': 'tester@trial.com',
            'FirstName': 'wer',
            'LastName': 'ewrwer'})
