...
class DataTypeMixInTestCase(unittest.TestCase):
    ...
    def test_write_ulong(self):
        ...
        self._write_endian(x, x.write_ulong, (4294967295,), ('\xff\xff\xff\xff', '\xff\xff\xff\xff'))
    ...
    def test_read_ulong(self):
        ...
        self._read_endian(['\xff\xff\xff\xff', '\xff\xff\xff\xff'], 'read_ulong', (), 4294967295)
    ...
    def test_write_long(self):
        ...
        self._write_endian(x, x.write_long, (2147483647,), ('\x7f\xff\xff\xff', '\xff\xff\xff\x7f'))
    ...
    def test_read_long(self):
        ...
        self._read_endian(['\x7f\xff\xff\xff', '\xff\xff\xff\x7f'], 'read_long', (), 2147483647)
    ...
    def test_write_utf8_string(self):
        ...
        self._write_endian(x, x.write_utf8_string, ('ᚠᛇᚻ',), ['\xe1\x9a\xa0\xe1\x9b\x87\xe1\x9a\xbb'] * 2)
    ...
    def test_read_utf8_string(self):
        self._read_endian(['\xe1\x9a\xa0\xe1\x9b\x87\xe1\x9a\xbb'] * 2, 'read_utf8_string', (9,), 'ᚠᛇᚻ')
...
class GetClassMetaTestCase(unittest.TestCase):
    ...
    def test_types(self):
        ...
        for t in ['', '', 1, 1.0, 1, [], {}, object, object(), A(), B()]:
