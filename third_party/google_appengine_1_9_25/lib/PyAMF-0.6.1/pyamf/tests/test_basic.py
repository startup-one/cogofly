...
class HelperTestCase(unittest.TestCase):
    ...
    def test_encode(self):
        self.assertEqual('\x06\x0fconnect\x05?\xf0\x00\x00\x00\x00\x00\x00',
            pyamf.encode('connect', 1.0).getvalue())

    def test_decode(self):
        expected = ['connect', 1.0]
...
class UnregisterClassTestCase(ClassCacheClearingTestCase):
    def test_klass(self):
        ...
        self.assertTrue(Spam not in list(pyamf.CLASS_CACHE.keys()))
...
class TypeMapTestCase(unittest.TestCase):
    ...
    def test_add_callable(self):
        ...
        self.assertTrue(td in list(pyamf.TYPE_MAP.values()))
...
class ErrorClassMapTestCase(unittest.TestCase):
    ...
    def test_remove(self):
        ...
        self.assertFalse('abc' in list(pyamf.ERROR_CLASS_MAP.keys()))
...
class RegisterAliasTypeTestCase(unittest.TestCase):
    ...
    def test_single(self):
        ...
        self.assertTrue(DummyAlias in list(pyamf.ALIAS_TYPES.keys()))
