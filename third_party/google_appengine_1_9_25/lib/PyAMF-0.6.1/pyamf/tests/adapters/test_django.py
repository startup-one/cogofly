...
class ForeignKeyTestCase(BaseTestCase):
    ...
    def test_many_to_many(self):
        ...
        self.assertEqual(attrs, {'headline': 'Django lets you build Web apps easily'})
...
class FieldsTestCase(BaseTestCase):
    ...
    def test_file(self):
        ...
        self.assertEqual(attrs, {'text': '', 'id': 1, 'file': 'file_model/bar'})
...
class ImageTestCase(BaseTestCase):
    ...
    def test_image(self):
        ...
        self.assertEqual(attrs, {'text': '', 'id': 1, 'file': 'profile/bar'})
