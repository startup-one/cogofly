...
class RemotingService(object):
    ...
    def __init__(self, url, amf_version=pyamf.AMF0, **kwargs):
        ...
        self.opener = kwargs.pop('opener', six.moves.urllib.request.urlopen)
    ...
    def _setUrl(self, url):
        """
        """
        self.url = six.moves.urllib.parse.urllib.parse(url)
        self._root_url = url
    ...
    def execute_single(self, request):
        ...
        http_request = six.moves.urllib.request.Request(self._root_url, body.getvalue(),
