...
class Configuration(six.moves.configparser.SafeConfigParser):
    ...
    def defaults(self):
        ...
        """
        return six.moves.configparser.SafeConfigParser.defaults(self)
    ...
    def sections(self):
        ...
        """
        return six.moves.configparser.SafeConfigParser.sections(self)
    ...
    def add_section(self, section):
        ...
        """
        six.moves.configparser.SafeConfigParser.add_section(self, section)
    ...
    def has_section(self, section):
        ...
        :return: ``True`` if the section exists in the configuration, ``False``
                 if not.
        """
        return six.moves.configparser.SafeConfigParser.has_section(self, section)
    ...
    def options(self, section):
        ...
        """
        return six.moves.configparser.SafeConfigParser.options(self, section)
    ...
    def has_option(self, section, option):
        ...
        """
        return six.moves.configparser.SafeConfigParser.has_option(self, section, option)
    ...
    def get(self, section, option, optional=False):
        ...
        def do_get(section, option):
            val = six.moves.configparser.SafeConfigParser.get(self, section, option)
            if len(val.strip()) == 0:
                raise six.moves.configparser.NoOptionError(option, section)
            return val
    ...
    def getint(self, section, option, optional=False):
        ...
        """
        def do_get(section, option):
            return six.moves.configparser.SafeConfigParser.getint(self, section, option)
    ...
    def getfloat(self, section, option, optional=False):
        ...
        """
        def do_get(section, option):
            return six.moves.configparser.SafeConfigParser.getfloat(self, section, option)
    ...
    def getboolean(self, section, option, optional=False):
        ...
        '''
        def do_get(section, option):
            return six.moves.configparser.SafeConfigParser.getboolean(self,
                                                            section,
                                                            option)
    ...
    def getlist(self, section, option, sep=None, optional=False):
        ...
        '''
        def do_get(section, option):
            value = six.moves.configparser.SafeConfigParser.get(self, section, option)
    ...
    def items(self, section):
        ...
        :raise NoSectionError: no such section
        """
        return six.moves.configparser.SafeConfigParser.items(self, section)
    ...
    def set(self, section, option, value):
        ...
        :raise NoSectionError: no such section
        """
        six.moves.configparser.SafeConfigParser.set(self, section, option, value)
    ...
    def write(self, fileobj):
        ...
        """
        six.moves.configparser.SafeConfigParser.write(self, fileobj)
    ...
    def remove_section(self, section):
        ...
        :raise NoSectionError: no such section
        """
        six.moves.configparser.SafeConfigParser.remove_section(self, section)
    ...
    def __preprocess(self, fp, name):
        ...
        parsedConfig = six.moves.configparser.SafeConfigParser()
