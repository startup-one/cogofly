...
class FetchRequest(AXMessage):
    ...
    def getExtensionArgs(self):
        ...
        for type_uri, attribute in list(self.requested_attributes.items()):
    ...
    def parseExtensionArgs(self, ax_args):
        ...
        for key, value in list(ax_args.items()):
    ...
    def iterAttrs(self):
        ...
        """
        return iter(list(self.requested_attributes.values()))
...
class AXKeyValueMessage(AXMessage):
    ...
    def _getExtensionKVArgs(self, aliases=None):
        ...
        for type_uri, values in list(self.data.items()):
            alias = aliases.add(type_uri)
    ...
    def parseExtensionArgs(self, ax_args):
        ...
        for type_uri, alias in list(aliases.items()):
            try:
