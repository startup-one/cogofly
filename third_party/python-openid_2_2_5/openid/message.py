...
class Message(object):
    ...
    def _fromOpenIDArgs(self, openid_args):
        ...
        # Resolve namespaces
        for rest, value in list(openid_args.items()):
            try:
    ...
    def toPostArgs(self):
        ...
        for ns_uri, alias in list(self.namespaces.items()):
        ...
        for (ns_uri, ns_key), value in list(self.args.items()):
    ...
    def toArgs(self):
        ...
        kvargs = {}
        for k, v in list(post_args.items()):
    ...
    def toFormMarkup(self,
        ...
        if form_tag_attrs:
            for name, attr in list(form_tag_attrs.items()):
        ...
        for name, value in list(self.toPostArgs().items()):
            attrs = {
                'type': 'hidden',
    ...
    def getArgs(self, namespace):
        ...
        namespace = self._fixNS(namespace)
        args = []
        for ((pair_ns, ns_key), value) in list(self.args.items()):
...
class NamespaceMap(object):
    ...
    def items(self):
        ...
        """
        return list(self.namespace_to_alias.items())
