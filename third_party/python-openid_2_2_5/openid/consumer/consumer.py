...
class GenericConsumer(object):
    ...
    def _checkReturnTo(self, message, return_to):
        ...
        # the two URLs.
        app_parts = urllib.parse(urinorm.urinorm(return_to))
        msg_parts = urllib.parse(urinorm.urinorm(msg_return_to))
    ...
    def _verifyReturnToArgs(query):
        ...
        parsed_url = urllib.parse(return_to)
        ...
        for pair in list(bare_args.items()):
