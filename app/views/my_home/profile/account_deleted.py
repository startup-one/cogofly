...
class AccountDeletedView(LoginRequiredMixin, generic.TemplateView):
    template_name = 'my_home/profile/redirect/account_deleted.html'

    def get_context_data(self, **kwargs):
        # 'contact_id' = param de l'URL => dans kwargs => faire suivre kwargs :
        common = CommonView(self, **kwargs)
        context = super(AccountDeletedView, self).get_context_data(**kwargs)
